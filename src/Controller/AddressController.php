...
class AddressController extends AbstractController
{
    ...
    public function new(Request $request, AddressRepository $addressRepository): Response
    {
        ...
        return $this->renderForm('account/address/actions/new.html.twig', [
            'address' => $address,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('account/address/actions/show.html.twig', [
            'address' => $address,
        ]);
    }
    ...
    public function edit(Request $request, Address $address, AddressRepository $addressRepository): Response
    {
        ...
        return $this->renderForm('account/address/actions/edit.html.twig', [
            'address' => $address,
            'form' => $form,
        ]);
    }
