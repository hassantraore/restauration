...
class IngredientController extends AbstractController
{
    ...
    public function new(Request $request, IngredientRepository $ingredientRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_ingredient', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('admin/ingredient/actions/new.html.twig', [
    ...
    {
        return $this->render('admin/ingredient/actions/show.html.twig', [
            'ingredient' => $ingredient,
        ]);
    }
    ...
    public function edit(Request $request, Ingredient $ingredient, IngredientRepository $ingredientRepository): Response
    {
        ...
        return $this->renderForm('admin/ingredient/actions/edit.html.twig', [
            'ingredient' => $ingredient,
            'form' => $form,
        ]);
    }
